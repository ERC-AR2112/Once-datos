...
gob <- tribble(
  ...
  "BA", "Jerônimo Rodrigues",                 "PT",            "Centroizquierda",      "Aliado de Lula",              "alta",     "",
  "CE", "Elmano de Freitas",                  "PT",            "Centroizquierda",      "Aliado de Lula",              "alta",     "",
  ...
  "PI", "Rafael Fonteles",                    "PT",            "Centroizquierda",      "Aliado de Lula",              "alta",     "",
  ...
  "RN", "Fátima Bezerra",                     "PT",            "Centroizquierda",      "Aliado de Lula",              "alta",     "",
...
write.csv(gob, "Elecciones_Brasil/gob.csv")

### Ideología construida por partido con base a Robognesi, Ribeiro y Codato (2023)
gob <- read.csv("Elecciones_Brasil/gob2.csv")
